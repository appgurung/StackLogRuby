...
require_relative "lib/stacklog.rb"
require_relative "lib/stacklog/client.rb"
require_relative "test_server.rb"

class TestStackLogRuby < Minitest::Test
  LOG_LINE = "log line"
  ...
  def log_level_test(level, port, expected_level)
    ...
    stacklog_thread = Thread.start do
      logger = StackLog::Ruby.new("pp", options)
